...
export const metadata: Metadata = {
  ...
  description: 'Learn how to play 3Patti Sky step by step. Complete beginner guide with rules, gameplay, tips, and strategies for Teen Patti, Dragon Tiger, and more card games.',
  keywords: [
    'how to play 3Patti Sky',
    '3Patti Sky beginner guide',
    '3Patti Sky rules',
    'Teen Patti gameplay',
    '3Patti Sky tutorial',
    '3Patti Sky guide'
  ...
  alternates: {
    canonical: "https://3pattiskygame.com.pk/blog/how-to-play-3patti-sky",
  },
  openGraph: {
    title: 'How to Play 3Patti Sky - Complete Beginner Guide 2026',
    description: 'Learn how to play 3Patti Sky with step-by-step instructions, rules, and gameplay tips for beginners.',
    url: "https://3pattiskygame.com.pk/blog/how-to-play-3patti-sky",
    siteName: "3Patti Sky",
    locale: "en_US",
    type: "article",
  },
...
export default function HowToPlayPage() {
  const schemaData = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://3pattiskygame.com.pk/blog/how-to-play-3patti-sky"
    },
    "articleSection": "Gaming Guide",
    "keywords": "how to play 3Patti Sky, 3Patti Sky beginner guide, Teen Patti rules, card game tutorial",
    "inLanguage": "en-US"
  };
  ...
  return (
    <article className="py-12 px-4 md:px-8 max-w-4xl mx-auto">
      ...
      <nav className="mb-8 text-sm">
        ...
        <span className="text-gray-500 mx-2">/</span>
        <span className="text-gray-400">How to Play 3Patti Sky</span>
      </nav>

      <header className="mb-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">
          How to Play 3Patti Sky - Complete Beginner Guide 2026
        </h1>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section id="download-setup" className="mb-12">
          ...
          <div className="bg-secondary rounded-xl p-6 md:p-8 mb-6">
            ...
            <ol className="list-decimal list-inside space-y-3 text-gray-300">
              <li>Visit the official 3Patti Sky website or download from the trusted source</li>
          ...
          <div className="bg-secondary rounded-xl p-6 md:p-8">
            ...
            <ol className="list-decimal list-inside space-y-3 text-gray-300">
              <li>Open the 3Patti Sky app after installation</li>
        ...
        <section id="teen-patti" className="mb-12">
          ...
          <div className="bg-secondary rounded-xl p-6 md:p-8">
            <p className="text-gray-300 mb-4 leading-relaxed">
              Teen Patti is the most popular game on 3Patti Sky. Here's how to play:
            </p>
        ...
        <section id="faq" className="mb-12">
          ...
          <div className="space-y-6">
            <div className="bg-secondary rounded-xl p-6 md:p-8">
              <h3 className="text-xl font-semibold mb-3 text-accent">Can I play 3Patti Sky for free?</h3>
              <p className="text-gray-300">
                Yes, 3Patti Sky offers free games and practice modes where you can play without real money. However, to earn real cash, you need to play with real money bets.
              </p>
            </div>
            <div className="bg-secondary rounded-xl p-6 md:p-8">
            ...
            <div className="bg-secondary rounded-xl p-6 md:p-8">
              <h3 className="text-xl font-semibold mb-3 text-accent">Is 3Patti Sky safe to play?</h3>
              <p className="text-gray-300">
                Yes, 3Patti Sky uses secure payment methods and encryption to protect your personal and financial information. Always download from official sources.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="bg-[#0A1029] rounded-xl p-6 md:p-8 mt-12">
          ...
          <p className="text-gray-300 mb-6">
            Now that you know how to play 3Patti Sky, download the app and start your gaming journey. Remember to play responsibly and within your budget.
          </p>
          <Link 
